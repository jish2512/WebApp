...
export declare module pouchDB {
    interface IPouchDB {
        ...
        allDocs<T>(): angular.IPromise<Response.IBatchFetch<T>>;
        allDocs<T>(options: Options.IBatchFetch): angular.IPromise<Response.IBatchFetch<T>>;

        // allDocs<T>(options: Options.IBatchFetch): angular.IPromise<Response.IBatchFetch<T>, IError>;
        //allDocs<T>(options: Options.IBatchFetch): angular.IPromise<any>;
        ...
        putAttachment(docId: string, attachmentId: string, attachment: Object, type: string): angular.IPromise<Response.IOk>;
        ...
        putAttachment(docId: string, attachmentId: string, rev: string, attachment: Object, type: string): angular.IPromise<Response.IOk>;
        ...
        getAttachment(docId: string, attachmentId: string): angular.IPromise<Response.IGetAttachement>;
        getAttachment(docId: string, attachmentId: string, options: Options.IGetAttachement): angular.IPromise<Response.IGetAttachement>;
        ...
        removeAttachment(docId: string, attachmentId: string, rev: string): angular.IPromise<Response.IOk>;
        removeAttachment(docId: string, attachmentId: string, rev: string, callback: (err: IError, res: Response.IOk) => void): any;

        query(fun: ((doc: any) => void) | string): angular.IPromise<any>;
        query(fun: ((doc: any) => void) | string, callback: (err: IError, res: any) => void): any;
        query(fun: ((doc: any) => void) | string, options: Options.IQuery): angular.IPromise<any>;
        query(fun: ((doc: any) => void) | string, options: Options.IQuery, callback: (err: IError, res: any) => void): any;

        viewCleanup(): angular.IPromise<Response.IViewCleanup>
        viewCleanup(callback: (err: IError, res: Response.IViewCleanup) => void): void

        info(): angular.IPromise<Response.IInfo>;
        info(callback: (err: IError, res: Response.IInfo) => void): void;

        compact(): angular.IPromise<Response.IOk>;
        compact(options: Options.ICompact): angular.IPromise<Response.IOk>;
        ...
        revsDiff(diff: Object): angular.IPromise<any>;
