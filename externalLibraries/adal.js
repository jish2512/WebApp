...
var AuthenticationContext = (function () {
    ...
    AuthenticationContext = function (config) {
        ...
        if (!this.config.frameRedirectUri) {
            this.config.frameRedirectUri = this.config.redirectUri;
        }
    ...
    */
    ...
    AuthenticationContext.prototype._renewToken = function (resource, callback, responseType) {
        ...
        var urlNavigate = this._urlRemoveQueryStringParameter(this._getNavigateUrl(responseType, resource, true), 'prompt');
  ...
  */
    ...
    */
     ...
     * @ignore
     */
    AuthenticationContext.prototype._getNavigateUrl = function (responseType, resource, forFrame) {
        var tenant = 'common';
        if (this.config.tenant) {
            tenant = this.config.tenant;
        }

        var urlNavigate = this.instance + tenant + '/oauth2/authorize' + this._serialize(responseType, this.config, resource, forFrame) + this._addLibMetadata();
     ...
     * @ignore
     */
    AuthenticationContext.prototype._serialize = function (responseType, obj, resource, forFrame) {
        var str = [];
        ...
        if (obj !== null) {
            ...
            var redirectUri = (forFrame ? (responseType === 'id_token' ? obj.redirectUri : obj.frameRedirectUri) : obj.redirectUri);
